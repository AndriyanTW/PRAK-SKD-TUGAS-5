...
plaintext = input("Insert your text to encrypt : ") #fungsi untuk tempat input text yang dienkript
keyA = int(input("Insert A Key : ")) #fungsi untuk memasukkan Key A
keyB = int(input("Insert B Key : ")) #fungsi untuk memasukkan Key B
